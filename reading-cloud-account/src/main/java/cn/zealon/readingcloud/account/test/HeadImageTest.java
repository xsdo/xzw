...
public class HeadImageTest {
     ...
     * @param fillet     圆角大小
     */
    public static String generateImg(String name, String outputPath, String outputName, Integer fillet) throws IOException {
        int width = 100;
        int height = 100;
        ...
        if (name.endsWith("1")){
            ...
            if (nameLen <= 3) {
                ...
                if (isChinese(first)) {
                    // 截取倒数两位汉字
                    nameWritten = name.substring(nameLen - 3);
                } else {
                    // 截取前面的两个英文字母
                    nameWritten = name.substring(0, 3).toUpperCase();
                }
            }
        }else {
        ...
        String filename = outputPath + outputName + ".jpg";
    ...
    public static void main(String[] args) throws IOException {
        String name = "xuqiangqiang";
        //name 姓名  outputPath 存放路径 fillet 圆角大小
        System.out.println(generateImg(name, "F:/Resource/News/", name, 30));
    }
